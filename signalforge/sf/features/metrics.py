...
def compute_metrics(address: str, trips: list[RoundTrip],
    ...
    # Annualize, but cap the basis at DAILY (252 periods) so a high-frequency
    # wallet can't inflate its per-trade ratio into an unheard-of Sharpe. A great
    # trader should land ~2-4 here, comparable to how Sharpe is conventionally read.
